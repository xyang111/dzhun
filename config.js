...
const BANK_PRODUCTS = [
  { id:'gsyh', bank:'工商银行', product:'融e借', hurdle:519, k:0.025, emoji:'🏦', rate:'3.0%-4.35%', amount:'最高100万', maxQ1:null, maxQ3:6, maxQ6:null, maxDebt:65, minIncome:5000, minAge:null, maxAge:null, overdue:'zero', social:true, minSocialMonths:12, minProvident:null, minEdu:'none', workTypes:null, conditions:'工行代发工资或公积金≥12月；无当前逾期；近3月查询≤6次；负债率≤65%', bonus:'国企/事业/央企/白名单单位通过率极高；公积金基数高额度更大', tags:['国有大行','利率低','公积金加分'], type:'bank' },
  { id:'nyyh', bank:'农业银行', product:'网捷贷', hurdle:513, k:0.025, emoji:'🌾', rate:'2.85%-4.5%', amount:'最高30万', maxQ1:null, maxQ3:6, maxQ6:null, maxDebt:70, minIncome:3000, minAge:null, maxAge:null, overdue:'zero', social:true, minSocialMonths:6, minProvident:null, minEdu:'none', workTypes:null, conditions:'农行账户；社保或公积金在缴；无当前逾期；近3月查询≤6次', bonus:'公务员/国企优先；农行代发工资利率更低；有农行按揭额度翻倍', tags:['国有大行','公积金加分','随借随还'], type:'bank' },
  { id:'zgyh', bank:'中国银行', product:'随心智贷', hurdle:524, k:0.025, emoji:'🏛', rate:'3.1%-5.22%', amount:'最高50万', maxQ1:null, maxQ3:6, maxQ6:null, maxDebt:60, minIncome:6000, minAge:null, maxAge:null, overdue:'zero', social:false, minSocialMonths:null, minProvident:null, minEdu:'none', workTypes:null, conditions:'无当前逾期；近3月查询≤6次；负债率≤60%；月收入≥6000', bonus:'名下有全款房通过率+20%；中行按揭客户优先；公积金在缴利率更低', tags:['国有大行','有房加分','利率低'], type:'bank' },
  { id:'jsyh', bank:'建设银行', product:'快贷', hurdle:513, k:0.025, emoji:'🏗', rate:'2.85%-4.8%', amount:'最高100万', maxQ1:null, maxQ3:6, maxQ6:null, maxDebt:70, minIncome:4000, minAge:null, maxAge:null, overdue:'zero', social:true, minSocialMonths:6, minProvident:null, minEdu:'none', workTypes:null, conditions:'建行账户；社保或公积金在缴；无当前逾期；近3月查询≤6次', bonus:'建行代发工资额度大幅提升；有房贷客户额度最高；龙卡信用卡加分', tags:['国有大行','额度高','公积金加分'], type:'bank' },
  ...
  { id:'zsyh', bank:'招商银行', product:'闪电贷', hurdle:530, k:0.025, emoji:'💳', rate:'2.68%-18%', amount:'最高50万', maxQ1:2, maxQ3:4, maxQ6:null, maxDebt:65, minIncome:5000, minAge:null, maxAge:null, overdue:'zero', social:false, minSocialMonths:null, minProvident:null, minEdu:'none', workTypes:null, conditions:'无当前逾期；近1月查询≤2次；近3月查询≤4次；负债率≤65%', bonus:'招行代发/AUM≥2万利率更低；公积金高基数显著提额', tags:['秒级审批','全线上','利率低'], type:'bank' },
  ...
  { id:'xmyh', bank:'厦门银行', product:'E秒贷', hurdle:480, k:0.025, emoji:'🏝', rate:'5.38%-7.2%', amount:'最高60万', maxQ1:null, maxQ3:6, maxQ6:null, maxDebt:65, minIncome:4000, minAge:null, maxAge:null, overdue:'zero', social:true, minSocialMonths:6, minProvident:null, minEdu:'none', workTypes:null, conditions:'无当前逾期；近1周查询≤3次；近3月查询≤6次；未结清贷款≤5家；社保或公积金≥6月', bonus:'厦门本地银行优先；公积金优质单位可拉白名单提额至60万', tags:['厦门本地','公积金优先','额度高'], type:'bank' },
  ...
  { id:'nbyh', bank:'南银法巴银行', product:'诚易贷', hurdle:436, k:0.025, emoji:'🏦', rate:'7.2%-18.8%', amount:'最高30万（夫妻各自申请）', maxQ1:5, maxQ3:9, maxQ6:15, maxDebt:null, minIncome:null, minAge:22, maxAge:56, overdue:'mild', social:true, minSocialMonths:6, minProvident:null, minEdu:'none', workTypes:null, conditions:'年龄22-56周岁；本地户籍：个税/公积金/社保≥6个月；外地户籍：≥12个月；近1月查询≤5次，近3月≤9次，半年≤15次；当前不能逾期，历史总逾期次数≤12次，历史无M2', bonus:'硕士/博士利率7.2%-9%最低；本科+公积金月缴≥2千利率9%-12%；查询要求最宽松', tags:['查询宽松','外地户籍可做','学历利率优惠'], type:'bank' },
