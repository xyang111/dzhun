...
const BANK_PRODUCTS = [
  ...
  { id:'zxyh', bank:'中信银行', product:'信秒贷', emoji:'🏢', rate:'3.28%-16.68%', amount:'最高50万', maxQ1:null, maxQ3:6, maxQ6:10, maxDebt:70, minIncome:4000, minAge:null, maxAge:null, overdue:'mild', social:false, minSocialMonths:null, minProvident:null, minEdu:'none', workTypes:null, conditions:'无当前逾期（历史单次≤30天可接受）；近3月查询≤6次；近6月查询≤10次；满足之一：中信代发/AUM/信用卡/按揭/公积金≥2年', bonus:'条件多选一通过率高；有按揭房直接符合；优质单位门槛更低', tags:['条件多选一','征信轻微瑕疵可做','审批快'], type:'bank' },
  { id:'gdyh', bank:'光大银行', product:'光速贷', emoji:'☀️', rate:'2.9%-6%', amount:'最高30万', maxQ1:null, maxQ3:5, maxQ6:null, maxDebt:70, minIncome:4000, minAge:null, maxAge:null, overdue:'zero', social:true, minSocialMonths:6, minProvident:null, minEdu:'none', workTypes:null, conditions:'社保或公积金；无当前逾期；近3月查询≤5次；负债率≤70%', bonus:'光大信用卡持有者加分；负债稍高也可接受', tags:['负债宽松','社保加分','利率低'], type:'bank' },
  { id:'hxyh', bank:'华夏银行', product:'易达金', emoji:'🌈', rate:'3.28%-6%', amount:'最高50万', maxQ1:null, maxQ3:8, maxQ6:null, maxDebt:75, minIncome:4000, minAge:null, maxAge:null, overdue:'zero', social:false, minSocialMonths:null, minProvident:null, minEdu:'none', workTypes:null, conditions:'无当前逾期；近3月查询≤8次；负债率≤75%', bonus:'私企员工友好；查询偏多时的次优选择；负债稍高也可尝试', tags:['私企友好','查询宽松','负债宽松'], type:'bank' },
  { id:'xmyh', bank:'厦门银行', product:'E秒贷', emoji:'🏝', rate:'5.38%-7.2%', amount:'最高60万', maxQ1:null, maxQ3:6, maxQ6:null, maxDebt:65, minIncome:4000, minAge:null, maxAge:null, overdue:'zero', social:true, minSocialMonths:6, minProvident:null, minEdu:'none', workTypes:null, conditions:'无当前逾期；近1周查询≤3次；近3月查询≤6次；未结清贷款≤5家；社保或公积金≥6月', bonus:'厦门本地银行优先；公积金优质单位可拉白名单提额至60万', tags:['厦门本地','公积金优先','额度高'], type:'bank' },
  { id:'xmns', bank:'厦门农商银行', product:'信用消费贷', emoji:'🌺', rate:'4.0%-6.5%', amount:'最高50万', maxQ1:null, maxQ3:4, maxQ6:6, maxDebt:70, minIncome:3000, minAge:null, maxAge:null, overdue:'zero', social:true, minSocialMonths:6, minProvident:null, minEdu:'none', workTypes:null, conditions:'厦门本地居民；无当前逾期；近3月查询≤4次；近6月查询≤6次；社保或公积金在缴', bonus:'公积金优质单位额度利率最优；线下沟通空间大；本地居民首选', tags:['厦门本地','公积金首选','线下可谈'], type:'bank' },
  { id:'nbyh', bank:'南银法巴银行', product:'诚易贷', emoji:'🏦', rate:'7.2%-18.8%', amount:'最高30万（夫妻各自申请）', maxQ1:5, maxQ3:9, maxQ6:15, maxDebt:null, minIncome:null, minAge:22, maxAge:56, overdue:'mild', social:true, minSocialMonths:6, minProvident:null, minEdu:'none', workTypes:null, conditions:'年龄22-56周岁；本地户籍：个税/公积金/社保≥6个月；外地户籍：≥12个月；近1月查询≤5次，近3月≤9次，半年≤15次；当前不能逾期，历史总逾期次数≤12次，历史无M2', bonus:'硕士/博士利率7.2%-9%最低；本科+公积金月缴≥2千利率9%-12%；查询要求最宽松', tags:['查询宽松','外地户籍可做','学历利率优惠'], type:'bank' },
  { id:'zljr', bank:'招联消费金融', product:'好期贷', emoji:'📱', rate:'7.2%-24%', amount:'最高20万', maxQ1:null, maxQ3:99, maxQ6:null, maxDebt:85, minIncome:2000, minAge:null, maxAge:null, overdue:'mild', social:false, minSocialMonths:null, minProvident:null, minEdu:'none', workTypes:null, conditions:'有稳定收入；历史逾期已还清可申请；查询次数基本不影响', bonus:'银行全拒后保底首选；秒批到账；持牌消费金融机构', tags:['持牌机构','查询不限','保底首选'], type:'finance' },
  { id:'hxxd', bank:'海翔小贷', product:'信用贷', emoji:'🦅', rate:'利率面议', amount:'10-100万', maxQ1:null, maxQ3:99, maxQ6:null, maxDebt:80, minIncome:null, minAge:22, maxAge:55, overdue:'zero', social:true, minSocialMonths:null, minProvident:null, minEdu:'none', workTypes:null, conditions:'上班族；省内户籍或厦门房产；年龄22-55；无当前逾期；2年内展期/公积金提取不准入', bonus:'优质单位/高公积金/可双签均可提额；10-30万可最高40%先息', tags:['本地小贷','厦门户籍优先','大额可做'], type:'finance' },
  { id:'zyxf', bank:'中邮消费金融', product:'消费贷', emoji:'📬', rate:'18%-23.76%', amount:'最高20万', maxQ1:3, maxQ3:9, maxQ6:null, maxDebt:null, minIncome:null, minAge:20, maxAge:55, overdue:'mild', social:true, minSocialMonths:6, minProvident:null, minEdu:'none', workTypes:null, conditions:'年龄20-55；本单位满6个月；负债三选一：公积金/社保/个税基数×50倍≥信贷余额；近3月信贷查询≤9次', bonus:'负债要求三选一非常灵活；公积金/社保/个税任一满足即可', tags:['负债要求灵活','查询宽松','持牌消费金融'], type:'finance' },
  { id:'zbyh', bank:'中银消费金融', product:'消费贷', emoji:'🏛', rate:'14.98%-22.98%', amount:'最高20万', maxQ1:null, maxQ3:7, maxQ6:null, maxDebt:null, minIncome:null, minAge:20, maxAge:55, overdue:'mild', social:true, minSocialMonths:6, minProvident:null, minEdu:'college', workTypes:null, conditions:'年龄20-55；上班族；大专及以上学历；3个月机构查询≤7次；无当前逾期；至少有一笔正常还款6个月以上', bonus:'社保基数5000+大专学历利率最低14.98%；夫妻可各自申请合计40万', tags:['双系统','社保基数关键','大专可做'], type:'finance' },
  { id:'xyjr', bank:'兴业消费金融', product:'消费贷', emoji:'💼', rate:'8.88%-16.8%', amount:'5-20万（夫妻40万）', maxQ1:null, maxQ3:10, maxQ6:null, maxDebt:null, minIncome:5000, minAge:22, maxAge:60, overdue:'mild', social:true, minSocialMonths:6, minProvident:null, minEdu:'none', workTypes:null, conditions:'年龄22-60；社保6个月以上，月工资5000以上；近3月查询≤10次；无当前逾期；不接受白户', bonus:'A1类irr年化8.88%最低；研究生学历直接最优利率；全款房客户20%认定额度', tags:['学历利率优惠','厦门社保6月','全款房加分'], type:'finance' },
  { id:'lyh', bank:'陆易花', product:'薪产品', emoji:'🌸', rate:'利率面议', amount:'2-20万循环额度', maxQ1:4, maxQ3:9, maxQ6:null, maxDebt:100, minIncome:null, minAge:22, maxAge:55, overdue:'loose', social:true, minSocialMonths:6, minProvident:null, minEdu:'none', workTypes:null, conditions:'年龄22-55；上班族（不含企业法人/股东/个体）；企业缴社保≥6个月；无当前逾期200元以下可申请；近3月查询<9次', bonus:'循环额度最灵活；支持12/24/36期；换单位只需保证连续缴纳即可', tags:['循环额度','上班族专属','线上操作'], type:'finance' },
];
